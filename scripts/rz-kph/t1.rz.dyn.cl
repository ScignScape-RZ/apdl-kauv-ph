...
(setq kto (ka::kc :|kcm_type_object_by_qregistered_type_name| "Fn_Doc_Multi*") )
(ka::kc :|kcm_add_type_binding| "fnm" kto)
(setq kcx (ka::kc :|kcm_promote_type_binding_to_statement_via_type_default_literal__let| kcg "fnm"))
...
(ka::kc :|kcg_add_lambda_carrier_via_symbol| kcg "_$")
...
(setq kcs (ka::kc :|kcm_promote_overloadable_function_type_binding_to_statement| "play_sample" kto))
(setq cmd-pkg (ka::kc :|kcm_statement_to_command_package| kcs))
(ka::kc :|kcm_direct_eval| cmd-pkg)
; _fn_sig (no def) ...
...
(ka::kc :|kcg_add_lambda_carrier_via_typed_literal| kcg kto "play_sample")
(setq kcx (ka::kc :|kcm_dissolve_to_nested_expression| kcg))
(setq kcs (ka::kc :|kcm_promote_expression_to_statement| kcx))
(setq cmd-pkg (ka::kc :|kcm_statement_to_command_package| kcs))
(ka::kc :|kcm_direct_eval| cmd-pkg)
...
(ka::kc :|kcg_add_sigma_carrier_via_symbol| kcg "fnm")
(setq kto (ka::kc :|kcm_type_object__str|))
(ka::kc :|kcg_add_lambda_carrier_via_typed_literal| kcg kto "show_distractor_text")
(setq kcx (ka::kc :|kcm_dissolve_to_nested_expression| kcg))
(setq kcs (ka::kc :|kcm_promote_expression_to_statement| kcx))
(setq cmd-pkg (ka::kc :|kcm_statement_to_command_package| kcs))
(ka::kc :|kcm_direct_eval| cmd-pkg)
...
(ka::kc :|kcm_direct_eval| cmd-pkg)
(ka::kc :|kcg_clear_all| kcg)
(ka::kc :|kcm_kcg_add_fuxe_carrier| kcg kto  "kph_gen_multi")
(ka::kc :|kcg_add_sigma_carrier_via_symbol| kcg "fnm")
(setq kto (ka::kc :|kcm_type_object__str|))
(ka::kc :|kcg_add_lambda_carrier_via_typed_literal| kcg kto "@/cpp/kph/gen-multi/t1.kph")
(setq kcx (ka::kc :|kcm_dissolve_to_nested_expression| kcg))
(setq kcs (ka::kc :|kcm_promote_expression_to_statement| kcx))
(setq cmd-pkg (ka::kc :|kcm_statement_to_command_package| kcs))
(ka::kc :|kcm_direct_eval| cmd-pkg)
